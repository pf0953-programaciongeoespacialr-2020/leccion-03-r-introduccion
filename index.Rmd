...
paises = c("PA", "CR", "NI", "ES", "HN", "GU", "BE", "DO")
...
ca_covid19 <- read.csv(file='datos/ca-covid19.csv')
...
```{r}
# Todas las filas de las columnas 1 (Date), 3 (Barcelona), 20 (México DF) y 21 (Milán)
...
barplot(
  ...
  main="Casos confirmados de Covid-19 en países centroamericanos y DO"
)
```
